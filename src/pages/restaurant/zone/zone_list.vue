  ...
  <AppLayout>
    <MainContentWarp>
      <div class="p-2 surface-section flex-auto">
        <div class="p-1">
          <router-link to="/restaurant/zone/zone_import">
            <Button
              label="นำเข้าข้อมูลโซน"
...
function confirmDel() {
  ...
  console.log(deldata);
  RestaurantService.delZone(deldata)
    .then((res) => {
      console.log(res);
      if (res.success) {
        getZoneList();
